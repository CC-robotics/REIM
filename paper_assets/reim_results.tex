...
official clean benchmark scores.
...
heuristic gate is consistent across seeds. This analysis concerns the
current supervised recovery gate; the earlier PPO recovery negative control
remains excluded from this paper.
...
training-design choices for the earlier PPO recovery variant on 200 paired
Meta-World development seeds at 20\% disturbance. Exact online trigger-state
