\begin{table}[t]
  ...
  (bank 20265010, 50 episodes per task per seed). Each cell is task-macro
  success for one training seed; the final column reports the mean $\pm$ one
  standard deviation across the three seeds. Seed-to-seed variation is small
  relative to the noise-0.4 gap over the heuristic gate.}
